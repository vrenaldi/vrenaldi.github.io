...
let neon = svg.filter(Snap.filter.shadow(0, 0, "#2196F3", 3.5));
...
export function loadSkills(): void {
    ...
    Snap.animate(0, skills.html.strength, function (val): void {
        ...
        skills.html.snapObj = svg.path(`M ${skills.html.startX} ${skills.html.startY} A ${skills.html.radius} ${skills.html.radius} ${skills.html.rotationX} ${skills.html.largeArc} ${skills.html.sweep} ${skills.html.endX} ${skills.html.endY}`).attr({ class: skills.html.class, filter: neon });
    ...
    Snap.animate(0, skills.css.strength, function (val): void {
        ...
        skills.css.snapObj = svg.path(`M ${skills.css.startX} ${skills.css.startY} A ${skills.css.radius} ${skills.css.radius} ${skills.css.rotationX} ${skills.css.largeArc} ${skills.css.sweep} ${skills.css.endX} ${skills.css.endY}`).attr({ class: skills.html.class, filter: neon });
    ...
    Snap.animate(0, skills.ts.strength, function (val): void {
        ...
        skills.ts.snapObj = svg.path(`M ${skills.ts.startX} ${skills.ts.startY} A ${skills.ts.radius} ${skills.ts.radius} ${skills.ts.rotationX} ${skills.ts.largeArc} ${skills.ts.sweep} ${skills.ts.endX} ${skills.ts.endY}`).attr({ class: skills.html.class, filter: neon });
